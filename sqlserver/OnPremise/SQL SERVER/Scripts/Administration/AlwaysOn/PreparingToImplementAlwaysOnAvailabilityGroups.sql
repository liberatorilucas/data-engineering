...
SELECT
    ( SELECT 
          CAST(DATEADD(dd,( SELECT TOP 1 Number
                            FROM @Numbers
                            ORDER BY NEWID() )
        , GETDATE())AS DATE))
    ...
    ,( SELECT TOP 1 Number FROM @Numbers ORDER BY NEWID() )
    ,( SELECT TOP 1 Number FROM @Numbers ORDER BY NEWID() )
    ,( SELECT CAST(DATEADD(dd,( SELECT TOP 1 
                                        Number - 10
                                FROM @Numbers
                                ORDER BY NEWID()) 
              , GETDATE()) AS DATE) )
...
FROM (
        ...
        FROM @Numbers a) CreditCardNumber) d
CROSS JOIN @Numbers b
...
-- Check
-------------------------------------------------------------------------------------------------------------------------------------------------
SELECT COUNT(*) FROM [Accounts].[dbo].[PurchaseOrders]  -- 1000
SELECT COUNT(*) FROM [Customers].[dbo].[Customers]      -- 1000
SELECT COUNT(*) FROM [HR].[dbo].[Employees]             -- 100
SELECT COUNT(*) FROM [Sales].[dbo].[Orders]             -- 1000

SELECT * FROM [Accounts].[dbo].[PurchaseOrders]
