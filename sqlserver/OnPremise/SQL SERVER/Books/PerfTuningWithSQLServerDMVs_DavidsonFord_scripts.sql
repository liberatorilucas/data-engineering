/******************************************************************************************************
Complete Code Listing for "Performance Tuning with SQL Server DMVs" by Tim Ford and Louis Davidson
...
WHERE   DB_NAME(database_id) = 'SimpleTalk'
